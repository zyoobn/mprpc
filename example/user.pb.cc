...
const uint32_t TableStruct_user_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginResponse, _impl_.reslut_),
...
const char descriptor_table_protodef_user_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "esponse\022\"\n\006reslut\030\001 \001(\0132\022.fixbug.ResultC"
...
const ::_pbi::DescriptorTable descriptor_table_user_2eproto = {
    false, false, 264, descriptor_table_protodef_user_2eproto,
    "user.proto",
...
class LoginResponse::_Internal {
 public:
  static const ::fixbug::ResultCode& reslut(const LoginResponse* msg);
};
...
LoginResponse::LoginResponse(const LoginResponse& from)
  ...
  if (from._internal_has_reslut()) {
    _this->_impl_.reslut_ = new ::fixbug::ResultCode(*from._impl_.reslut_);
  }
...
void LoginResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_has_reslut()) {
    _this->_internal_mutable_reslut()->::fixbug::ResultCode::MergeFrom(
