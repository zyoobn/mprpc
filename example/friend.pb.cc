...
const uint32_t TableStruct_friend_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendsListResponse, _impl_.frineds_),
};
...
GetFriendsListResponse::GetFriendsListResponse(const GetFriendsListResponse& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.frineds_){from._impl_.frineds_}
    , decltype(_impl_.result_){nullptr}
    , /*decltype(_impl_._cached_size_)*/{}};
...
inline void GetFriendsListResponse::SharedCtor(
  ...
  (void)is_message_owned;
  new (&_impl_) Impl_{
      decltype(_impl_.frineds_){arena}
    , decltype(_impl_.result_){nullptr}
    , /*decltype(_impl_._cached_size_)*/{}
  };
}
...
inline void GetFriendsListResponse::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.frineds_.~RepeatedPtrField();
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          do {
            ptr += 1;
            auto str = _internal_add_frineds();
            ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
            CHK_(ptr);
...
uint8_t* GetFriendsListResponse::_InternalSerialize(
  ...
  // repeated bytes frineds = 3;
  for (int i = 0, n = this->_internal_frineds_size(); i < n; i++) {
    const auto& s = this->_internal_frineds(i);
...
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendsListResponse)
  ...
  // repeated bytes frineds = 3;
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_impl_.frineds_.size());
  for (int i = 0, n = _impl_.frineds_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::BytesSize(
      _impl_.frineds_.Get(i));
  }
...
void GetFriendsListResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.frineds_.MergeFrom(from._impl_.frineds_);
  if (from._internal_has_result()) {
...
void GetFriendsListResponse::InternalSwap(GetFriendsListResponse* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  _impl_.frineds_.InternalSwap(&other->_impl_.frineds_);
