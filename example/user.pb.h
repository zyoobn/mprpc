...
class LoginResponse final :
 ...
 public:
  ...
  // .fixbug.ResultCode reslut = 1;
  bool has_reslut() const;
  private:
  bool _internal_has_reslut() const;
  public:
  void clear_reslut();
  const ::fixbug::ResultCode& reslut() const;
  PROTOBUF_NODISCARD ::fixbug::ResultCode* release_reslut();
  ::fixbug::ResultCode* mutable_reslut();
  void set_allocated_reslut(::fixbug::ResultCode* reslut);
  private:
  const ::fixbug::ResultCode& _internal_reslut() const;
  ::fixbug::ResultCode* _internal_mutable_reslut();
  public:
  void unsafe_arena_set_allocated_reslut(
      ::fixbug::ResultCode* reslut);
  ::fixbug::ResultCode* unsafe_arena_release_reslut();
...
inline const ::fixbug::ResultCode& LoginResponse::_internal_reslut() const {
  const ::fixbug::ResultCode* p = _impl_.reslut_;
  return p != nullptr ? *p : reinterpret_cast<const ::fixbug::ResultCode&>(
      ::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& LoginResponse::reslut() const {
  // @@protoc_insertion_point(field_get:fixbug.LoginResponse.reslut)
...
inline void LoginResponse::unsafe_arena_set_allocated_reslut(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.LoginResponse.reslut)
}
inline ::fixbug::ResultCode* LoginResponse::release_reslut() {
  
  ::fixbug::ResultCode* temp = _impl_.reslut_;
  _impl_.reslut_ = nullptr;
...
inline ::fixbug::ResultCode* LoginResponse::unsafe_arena_release_reslut() {
  // @@protoc_insertion_point(field_release:fixbug.LoginResponse.reslut)
  
  ::fixbug::ResultCode* temp = _impl_.reslut_;
  _impl_.reslut_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* LoginResponse::_internal_mutable_reslut() {
...
inline ::fixbug::ResultCode* LoginResponse::mutable_reslut() {
  ::fixbug::ResultCode* _msg = _internal_mutable_reslut();
  // @@protoc_insertion_point(field_mutable:fixbug.LoginResponse.reslut)
  return _msg;
}
inline void LoginResponse::set_allocated_reslut(::fixbug::ResultCode* reslut) {
  ...
  _impl_.reslut_ = reslut;
  // @@protoc_insertion_point(field_set_allocated:fixbug.LoginResponse.reslut)
}
