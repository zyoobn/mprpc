...
class GetFriendsListResponse final :
 ...
 public:
  ...
  enum : int {
    kFrinedsFieldNumber = 3,
    kResultFieldNumber = 1,
  };
  // repeated bytes frineds = 3;
  int frineds_size() const;
  private:
  int _internal_frineds_size() const;
  public:
  void clear_frineds();
  const std::string& frineds(int index) const;
  std::string* mutable_frineds(int index);
  void set_frineds(int index, const std::string& value);
  void set_frineds(int index, std::string&& value);
  void set_frineds(int index, const char* value);
  void set_frineds(int index, const void* value, size_t size);
  std::string* add_frineds();
  void add_frineds(const std::string& value);
  void add_frineds(std::string&& value);
  void add_frineds(const char* value);
  void add_frineds(const void* value, size_t size);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& frineds() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>* mutable_frineds();
  private:
  const std::string& _internal_frineds(int index) const;
  std::string* _internal_add_frineds();
  public:
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string> frineds_;
...
// repeated bytes frineds = 3;
inline int GetFriendsListResponse::_internal_frineds_size() const {
  return _impl_.frineds_.size();
}
inline int GetFriendsListResponse::frineds_size() const {
  return _internal_frineds_size();
}
inline void GetFriendsListResponse::clear_frineds() {
  _impl_.frineds_.Clear();
}
inline std::string* GetFriendsListResponse::add_frineds() {
  std::string* _s = _internal_add_frineds();
  // @@protoc_insertion_point(field_add_mutable:fixbug.GetFriendsListResponse.frineds)
  return _s;
}
inline const std::string& GetFriendsListResponse::_internal_frineds(int index) const {
  return _impl_.frineds_.Get(index);
}
inline const std::string& GetFriendsListResponse::frineds(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendsListResponse.frineds)
  return _internal_frineds(index);
}
inline std::string* GetFriendsListResponse::mutable_frineds(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendsListResponse.frineds)
  return _impl_.frineds_.Mutable(index);
}
inline void GetFriendsListResponse::set_frineds(int index, const std::string& value) {
  _impl_.frineds_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:fixbug.GetFriendsListResponse.frineds)
}
inline void GetFriendsListResponse::set_frineds(int index, std::string&& value) {
  _impl_.frineds_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:fixbug.GetFriendsListResponse.frineds)
}
inline void GetFriendsListResponse::set_frineds(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.frineds_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:fixbug.GetFriendsListResponse.frineds)
}
inline void GetFriendsListResponse::set_frineds(int index, const void* value, size_t size) {
  _impl_.frineds_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:fixbug.GetFriendsListResponse.frineds)
}
inline std::string* GetFriendsListResponse::_internal_add_frineds() {
  return _impl_.frineds_.Add();
}
inline void GetFriendsListResponse::add_frineds(const std::string& value) {
  _impl_.frineds_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:fixbug.GetFriendsListResponse.frineds)
}
inline void GetFriendsListResponse::add_frineds(std::string&& value) {
  _impl_.frineds_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:fixbug.GetFriendsListResponse.frineds)
}
inline void GetFriendsListResponse::add_frineds(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _impl_.frineds_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:fixbug.GetFriendsListResponse.frineds)
}
inline void GetFriendsListResponse::add_frineds(const void* value, size_t size) {
  _impl_.frineds_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:fixbug.GetFriendsListResponse.frineds)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
GetFriendsListResponse::frineds() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendsListResponse.frineds)
  return _impl_.frineds_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
GetFriendsListResponse::mutable_frineds() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendsListResponse.frineds)
  return &_impl_.frineds_;
}
